export const sectionTemplates = {
    ...
    "mind-maps": `<div class="form__section form__section-group">
                        <div class="form__radio-group">
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="mind-maps" />
                                <span>Started</span>
                            </label>
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="mind-maps" />
    ...
    "test-cases": `<div class="form__section form__section-group">
                        <div class="form__radio-group">
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="test-cases" />
                                <span>Created</span>
                            </label>
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="test-cases" />
    ...
    "execution": `<div class="form__section form__section-group">
                        <div class="form__radio-group">
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="execution" />
                                <span>Dev</span>
                            </label>
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="execution" />
    ...
    "automation": `<div class="form__section form__section-group">
                        <div class="form__radio-group">
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="automation" />
                                <span>Started</span>
                            </label>
                            <label class="form__radio-label">
                                <input class="form__radio-input" type="radio" name="automation" />
    ...
    "hot-fix": `<div class="form__section form__section-group">
                    <div class="form__field">
                        <input class="form__input" type="text" name="form__input" placeholder="Enter Ticket Number" />
                    </div>
                </div>`,
